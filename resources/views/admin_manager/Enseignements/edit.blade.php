        ...
        <div class="dashboard-page-one">
            ...
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    <h3>@lang('Edit Teaching') {{ $enseignement->name}}</h3>
                    <ul>
                        <li>
                            <a href="index.html">@lang('Home')</a>
                        </li>
                        <li>@lang('Teachings')</li>
                    </ul>
                </div>
                    ...
                    <div class="col-4-xxxl col-12">
                        <div class="card height-auto">
                            <div class="card-body">
                                ...
                                <form class="new-added-form" method="POST" action="{{route('dashboard_manage.teaching.update', $enseignement->id)}}" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="row">
                                        <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                            <label>@lang('Teachings Name') *</label>
                                            <input type="text" value="{{$enseignement->name}}" name="name" placeholder="" class="form-control">
                                        </div>
                                        @error('name')
                                        ...
                                        <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                            ...
                                            <select value="{{old('section')}}" name="section_id" style="background-color: #f0f1f3;height: 50px; width:100%; border:none;border-radius: 4px;" class="select2">
                                            <option selected>@lang('select')</option>
                                                @foreach($sections as $section)
                                                    <option @if($enseignement->section->id == $section->id) selected @endif value="{{$section->id}}">{{$section->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                            @error('section')
                                        ...
                                        <tbody> 
                                            @foreach ($enseignements as $value)
                                                <tr data-entry-id="">
                                                    ...
                                                    <td>
                                                        <a href="{{ route('dashboard_manage.teaching.edit', $value->id)}}"
