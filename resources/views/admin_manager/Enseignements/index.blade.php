                    ...
                    <div class="col-4-xxxl col-12">
                        <div class="card height-auto">
                            <div class="card-body">
                                ...
                                <form class="new-added-form" method="POST" action="{{route('dashboard_manage.teaching.store')}}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <section id="elm" class="mb-4" >
                                        <div class="row">
                                            ...
                                            <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                                ...
                                                <select name="section[]" style="background-color: #f0f1f3;height: 50px; width:100%; border:none;border-radius: 4px;">
                                                ...
                                                <tr data-entry-id="">
                                                    <td>
                                                        <div class="form-check">
                                                            ...
                                                            <label class="form-check-label">{{$enseignement->id}}</label>
                                                        </div>
                                                    </td>
                                                    <td>{{$enseignement->name}}</td>
                                                    <td>{{$enseignement->section->name}}</td>
                                                    <td>{{$enseignement->created_at}}</td>
                                                    <td>
                                                        <a href="{{ route('dashboard_manage.teaching.edit', $enseignement->id)}}"
                                                            ...
                                                            <button onclick="deleteItem(this)" data-id="{{ $enseignement->id }}" class="btn btn-sm btn-clean btn-icon  delete"
                                                                title="Delete"> 
