                    ...
                    <div class="col-4-xxxl col-12">
                        <div class="card height-auto">
                            <div class="card-body">
                                ...
                                <form class="new-added-form" method="POST" action="{{ route('dashboard_manage.Sections.update', $section->id)}}" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                            <label>@lang('Section Name *')</label>
                                            <input type="text" value="{{$section->name}}" name="name" placeholder="" class="form-control">
                                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <form class="mg-b-20">
                                    <div class="row gutters-8">
                                        ...
                                        <div class="col-lg-3 col-12 form-group">
                                            <input type="text" placeholder="@lang('dd/mm/yyyy')" class="form-control">
                                        </div>
                                        ...
                                        <tbody> 
                                            @foreach ($sections as $value)
                                                <tr data-entry-id="">
                                                    ...
                                                    <td>
                                                        <a href="{{ route('dashboard_manage.Sections.edit', $value->id)}}"
