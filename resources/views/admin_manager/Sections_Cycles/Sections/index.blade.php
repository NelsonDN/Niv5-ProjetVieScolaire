                    ...
                    <div class="col-4-xxxl col-12">
                        <div class="card height-auto">
                            <div class="card-body">
                                ...
                                <form class="new-added-form" method="POST" action="{{route('dashboard_manage.Sections.store')}}" enctype="multipart/form-data">
                                    @csrf
                                        ...
                                        <tbody> 
                                            @foreach ($sections as $section)
                                                <tr data-entry-id="">
                                                    ...
                                                    <td>
                                                        <a href="{{ route('dashboard_manage.Sections.edit', $section->id)}}"
                                                        ...
                                                        <button onclick="deleteItem(this)" data-id="{{ $section->id }}" class="btn btn-sm btn-clean btn-icon  delete"
                                                            title="Delete"> 
