...
@section('script')
    ...
    <script>
        ...
        // }
        // onclick="showStuff('elm', 'pluss', this); return false;"
            ...
            <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <form action="{{ route('dashboard_manage.textbookTeacher.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                            <p style="background-color: thistle;">Vous etes ici :cahier de texte de --> {{$classe->nom}}</p> 
                            <div class="container">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <input value="{{old('titrecour')}}" name="titrecour" type="text">*
                                        @error('titrecour')
                                        <span class="form-text text-muted" role="alert"><strong class="text-danger">{{ $message }}</strong></span>
                                        @enderror
                                    </div>
                                ...
                                <div class="container" style="background-color: whitesmoke;">
                                    ...
                                    <div class="row" style="background-color:whitesmoke;">
                                        <div class="col">
                                            ...
                                            <input type="file" value="{{old('piece_jointecour')}}" name ="piece_jointecour" placeholder="Ajouter une piece jointe">
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-sm-12"> <label for="contenu" style="background-color: whitesmoke;" >Ajouter Un Contenu - ></label> 
                                        <textarea name="contenucour" value="{{old('contenucour')}}" id="" cols="80" rows="4"></textarea>
                                    </div>
                                    @error('contenucour')
                                        <span class="form-text text-muted" role="alert"><strong class="text-danger">{{ $message }}</strong></span>
                                    @enderror
                                    ...
                                    <div class="container" style="background-color: whitesmoke;">
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <input type="text" value="{{old('titre_exercice')}}" name="titre_exercice">
                                            </div>
                                            @error('titre_exercie')
                                                <span class="form-text text-muted" role="alert"><strong class="text-danger">{{ $message }}</strong></span>
                                            @enderror
                                        ...
                                        <div class="row">
                                            ...
                                            <input type="date" value="{{old('date_de_correction')}}" name="date_de_correction">
                                        ...
                                        <div class="row" style="background-color:whitesmoke;">
                                            <div class="col">
                                                <label for="pieces">Piéces jointes  - ></label>
                                                <input type="file" value="{{old('piece_jointeexercice')}}" name ="piece_jointeexercice" placeholder="Ajouter une piece jointe">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3 col-sm-12"> <label for="contenu" style="background-color: whitesmoke;" >Ajouter Un Contenu - ></label> 
                                                <textarea value="{{old('contenu_exercice')}}" name="contenu_exercice" id="" cols="60" rows="3"></textarea>
                            ...
                            <a href = "" title="Ajouter un exercice" id="pluss" style="float: right;"><i style="color:white; background-color: #ffae01;border-color:#ffae01; border-radius:4px; border:none; font-weight:500px; padding:12px 15px;" >Ajouter un travail</i></a>
                            <a href = "" title="Retirer" id="minus" style="float: right; margin-right:5px;"><i style="color:white; background-color: #042954;border-color:#042954; border-radius:4px; border:none; font-weight:500px; padding:12px 15px;">Retirer</i></a><br/>
                        </form>
