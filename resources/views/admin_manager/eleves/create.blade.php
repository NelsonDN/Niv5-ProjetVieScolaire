            ...
            <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <form class="new-added-form" method="POST" action="{{ route('dashboard_manage.eleves.store')}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" value="{{old('prename')}}" name="prename" placeholder="" class="form-control">
                                    @error('prename')
                                        <span class="form-text text-muted" role="alert"><strong class="text-danger">{{ $message }}</strong></span>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" value="{{old('matricule')}}" name="matricule" placeholder="" class="form-control">
                                    @error('matricule')
                                        <span class="form-text text-muted" role="alert"><strong class="text-danger">{{ $message }}</strong></span>
                                    @enderror
                                </div>
                            ...
                            <div class="row mt-4">
                                <div class="col-xl-6 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="date" value="{{old('date_naissance')}}" name="date_naissance" placeholder="" class="form-control">
                                    @error('date_naissance')
                                    <span class="form-text text-muted" role="alert"><strong class="text-danger">{{ $message }}</strong></span>
                                    @enderror
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group center">
                                    <label>@lang('Sexe') *</label>
                                    <select name="sexe" class="select2" required>
                                        <option disabled value=" ">@lang('Please Select sexe') *</option>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" value="{{old('telephone')}}" name="telephone" placeholder="" class="form-control">
                                    @error('telephone')
                                        <span class="form-text text-muted" role="alert"><strong class="text-danger">{{ $message }}</strong></span>
                                    @enderror
                                </div>
                                <div class="col-xl-6 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" value="{{old('localisation')}}" name="localisation" placeholder="" class="form-control">
                                    @error('localisation')
                                        <span class="form-text text-muted" role="alert"><strong class="text-danger">{{ $message }}</strong></span>
                                    @enderror
                                </div>
