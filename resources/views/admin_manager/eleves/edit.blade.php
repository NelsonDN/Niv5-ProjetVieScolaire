            ...
            <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <form class="new-added-form" method="POST" action="{{ route('dashboard_manage.eleves.update', $eleve->id)}}" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <div class="form-group row">
                                <label class="col-xl-3 col-lg-3 col-form-label text-left">@lang('Logo')</label>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" value="{{ $eleve->name  }}" name="name" placeholder="" class="form-control">
                                    @error('name')
                                        <span class="form-text text-muted" role="alert"><strong class="text-danger">{{ $message }}</strong></span>
                                    @enderror
                                </div>
                                <div class="col-xl-6 col-lg-6 col-12 form-group">
                                    <label>@lang("Second Name") *</label>
                                    <input type="text" value="{{ $eleve->prename  }}" name="prename" placeholder="" class="form-control">
                                    @error('prename')
                                        <span class="form-text text-muted" role="alert"><strong class="text-danger">{{ $message }}</strong></span>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-12 form-group center">
                                    <label>@lang('Classe') *</label>
                                    <select name="classe_id" class="select2" required>
                                        <option disabled value="multiselect">@lang('Please Select Class') *</option>
                                        @foreach ($classes as $classe )
                                            <option value="{{ $classe->id }}" @if($classe->id == $eleve->classe_id) selected @endif > {{ $classe->nom }} </option>
                                        @endforeach
                                    </select>
                                    @error('classe_id')
                                        <span class="form-text text-muted" role="alert"><strong class="text-danger">{{ $message }}</strong></span>
                                ...
                                <div class="col-xl-6 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" value="{{ $eleve->matricule }}" name="matricule" placeholder="" class="form-control">
                                    @error('matricule')
                                        <span class="form-text text-muted" role="alert"><strong class="text-danger">{{ $message }}</strong></span>
                                    @enderror
                                </div>
                            ...
                            <div class="row mt-4">
                                <div class="col-xl-6 col-lg-6 col-12 form-group">
                                    <label>@lang('Birthday Date') *</label>
                                    <input type="date" value="{{ $eleve->date_naissance  }}" name="date_naissance" placeholder="" class="form-control">
                                ...
                                <div class="col-xl-6 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" value="{{ $eleve->sexe  }}" name="sexe" placeholder="" class="form-control">
                                    @error('sexe')
                                    <span class="form-text text-muted" role="alert"><strong class="text-danger">{{ $message }}</strong></span>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" value="{{ $eleve->telephone  }}" name="telephone" placeholder="" class="form-control">
                                    @error('telephone')
                                        <span class="form-text text-muted" role="alert"><strong class="text-danger">{{ $message }}</strong></span>
                                    @enderror
                                </div>
                                <div class="col-xl-6 col-lg-6 col-12 form-group">
                                    <label>@lang('Localisation') *</label>
                                    <input type="text" value="{{ $eleve->localisation  }}" name="localisation" placeholder="" class="form-control">
                                    @error('localisation')
                                        <span class="form-text text-muted" role="alert"><strong class="text-danger">{{ $message }}</strong></span>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-lg-4 col-4 form-group">
                                    <label>Email </label>
                                    <input type="email" value="{{ $eleve->email  }}" name="email" placeholder="" class="form-control">
                                    @error('email')
                                        <span class="form-text text-muted" role="alert"><strong class="text-danger">{{ $message }}</strong></span>
                                    @enderror
                                </div>  
                                <div class="col-xl-4 col-lg-4 col-4 form-group">
                                    ...
                                    <input type="password" value="{{old('password')}}" name="password" placeholder="" class="form-control">
                                    @error('password')
                                        <span class="form-text text-muted" role="alert"><strong class="text-danger">{{ $message }}</strong></span>
                                    @enderror
                                </div>  
                                ...
                                <div class="col-12 form-group mg-t-8">
                                    <button type="submit" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">@lang('Enregister')</button>
