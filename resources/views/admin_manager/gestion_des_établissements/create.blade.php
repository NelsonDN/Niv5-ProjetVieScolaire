            ...
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    ...
                    <ul>
                        ...
                        <li>@lang('Creer un établissement')</li>
                    </ul>
                </div>
                    ...
                    <div class="card-body">
                        <div class="heading-layout1">
                            <div class="item-title">
                                <h3>@lang('Ajouter un établissement')</h3>
                            </div>
                           <div class="dropdown">
                        ...
                        <form class="new-added-form" method="POST" action="{{ route('dashboard_manage.etablissements.store')}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" value="{{old('nom')}}" name="nom" placeholder="" class="form-control">
                                    @error('nom')
                                        <span class="form-text text-muted" role="alert"><strong class="text-danger">{{ $message }}</strong></span>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" value="{{old('bp')}}" name="bp" placeholder="" class="form-control">
                                    @error('bp')
                                    <span class="form-text text-muted" role="alert"><strong class="text-danger">{{ $message }}</strong></span>
                                    @enderror
                                </div>
