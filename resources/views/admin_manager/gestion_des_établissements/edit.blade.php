            ...
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    ...
                    <ul>
                        ...
                        <li>@lang('Modifier un établissement')</li>
                    </ul>
                </div>
                    ...
                    <div class="card-body">
                        <div class="heading-layout1">
                            <div class="item-title">
                                <h3>@lang('Modifier un établissement')</h3>
                            </div>
                           <div class="dropdown">
                        ...
                        <form class="new-added-form" method="POST" action="{{ route('dashboard_manage.etablissements.update', $etablissement->id)}}" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                                ...
                                <div class="col-lg-9 col-xl-9">
                                    <div style="width: 120px;height: 120px;border-radius: 0.42rem;background-repeat: no-repeat;background-size: cover;border: 3px solid #ffffff; -webkit-box-shadow: 0 0.5rem 1.5rem 0.5rem rgb(0 0 0 / 8%); box-shadow: 0 0.5rem 1.5rem 0.5rem rgb(0 0 0 / 8%);" class="image-input image-input-outline" id="kt_user_add_avatar">
                                        ...
                                        <i style="position: absolute;right: 620px;top: -0.4px;"class="fa fa-pen icon-sm text-muted"></i>
                                            <input style="display: none;" type="file" placeholder="@lang('choose file')" name="logo" id="avatar" class="@error('logo') is-invalid @enderror" accept=".png, .jpg, .jpeg" value="
                                            {{old('logo')}}">
                                        </label>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-12 form-group">
                                    <label>@lang("Nom de l'etablissement") *</label>
                                    <input type="text" value="{{ $etablissement->nom }}" name="nom" placeholder="" class="form-control">
                                    @error('nom')
                                        <span class="form-text text-muted" role="alert"><strong class="text-danger">{{ $message }}</strong></span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-xl-6 col-lg-6 col-12 form-group">
                                    <label>Email *</label>
                                    <input type="email" value="{{$etablissement->email}}" name="email" placeholder="" class="form-control">
                                    @error('email')
                                        <span class="form-text text-muted" role="alert"><strong class="text-danger">{{ $message }}</strong></span>
                                    @enderror
                                </div>  
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" value="{{$etablissement->localisation}}" name="localisation" placeholder="" class="form-control">
                                    @error('localisation')
                                    <span class="form-text text-muted" role="alert"><strong class="text-danger">{{ $message }}</strong></span>
                                    @enderror
                                </div>
                                <div class="col-xl-6 col-lg-6 col-12 form-group">
                                    <label>@lang('Boite Postal') *</label>
                                    <input type="text" value="{{$etablissement->bp}}" name="bp" placeholder="" class="form-control">
                                    @error('bp')
                                    <span class="form-text text-muted" role="alert"><strong class="text-danger">{{ $message }}</strong></span>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" value="{{$etablissement->telephone}}" name="telephone" placeholder="" class="form-control">
                                    @error('telephone')
                                        <span class="form-text text-muted" role="alert"><strong class="text-danger">{{ $message }}</strong></span>
                                    @enderror
                                </div>
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    <label>@lang('Users manager') *</label>
