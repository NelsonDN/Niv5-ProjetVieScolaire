                    ...
                    <div class="col-4-xxxl col-12">
                        <div class="card height-auto">
                            <div class="card-body">
                                ...
                                <form class="new-added-form" method="POST" action="{{route('dashboard_manage.day.update' , $jour->id)}}" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="row">
                                        <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                            ...
                                            <input value="{{$jour->jour}}" name="jour" type="text" placeholder="" class="form-control">
                                            @error('jour')
                                    ...
                                    <table class="table display data-table text-nowrap">
                                        ...
                                        <tbody>
                                                ...
                                                <td>
                                                    ...
                                                    <td>
                                                        <a href="#" class="btn btn-danger" onclick="if (confirm('Voulez-vous vraiment supprimer la matière __ {{ $jour->jour }}__ ?')){document.getElementById('form-{{$jour->id}}').submit()}" >@lang('Delete')</a>
