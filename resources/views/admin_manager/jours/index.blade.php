        ...
        <div class="dashboard-page-one">
            ...
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    ...
                    <ul>
                        <li>
                            <a href="{{route('dashboard_manage.day.index')}}">@lang('Home')</a>
                        </li>
                        <li>@lang('Day')</li>
                    </ul>
                </div>
                    ...
                    <div class="col-4-xxxl col-12">
                        <div class="card height-auto">
                            <div class="card-body">
                                ...
                                <form class="new-added-form" method="POST" action="{{route('dashboard_manage.day.store')}}" enctype="multipart/form-data">
                                    @csrf
                                    @include('admin_manager.flash-message')
                                    <section id="elm" class="mb-4" >
                                        <div class="row">
                                            <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                                <label>@lang('Day Name')</label>
                                                <input value="{{old('jour.*')}}" name="jour[]" type="text" placeholder="" class="form-control">
                                                @error('jour.*')
                                    ...
                                    <table class="table display data-table text-nowrap">
                                        ...
                                        <tbody>
                                                ...
                                                <td>
                                                    ...
                                                    <td>
                                                        <a href="#" class="btn btn-danger" onclick="if (confirm('Voulez-vous vraiment supprimer la journée __ {{ $jour->jour }}__ ?')){document.getElementById('form-{{$jour->id}}').submit()}" >@lang('Delete')</a>
                                                            <form id="form-{{$jour->id}}" method="post" action ="{{ route('dashboard_manage.day.destroy', ['day'=> $jour->id])}}">
                                                            @csrf
                                                            @method('DELETE')
                                                    ...
                                                    <td>
                                                        <a href="{{ route('dashboard_manage.day.edit', $jour->id)}}"
                                                        ...
                                                        <button onclick="deleteItem(this)" data-id="{{ $jour->id }}" class="btn btn-sm btn-clean btn-icon  delete"
                                                            title="Delete"> 
