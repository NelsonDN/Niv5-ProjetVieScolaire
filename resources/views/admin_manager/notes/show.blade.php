                                ...
                                <tbody>
                                    ...
                                    @foreach($eleves as $eleve)
                                        <tr>
                                            ...
                                            <td>
                                                @if($eleve->users()->exists())
                                                    <button style="font-size: 2.5 rem;" type="button" class="btn btn-fill-lg bg-blue btn-hover-yellow" data-toggle="modal" data-target="#showparent-{{ $eleve->id }}">
                                                        SEE Parent
                                                    </button> 
                                                @else
                                        ...
                                        <div class="modal fade" id="showparent-{{ $eleve->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered modal-lg"  role="document">
                                                <div class="modal-content">
                                                <div style="background-color: #042954;" class="modal-header border-bottom-0 btn-secondary">
                                                    <h5 style="color:white;" class="modal-title" id="exampleModalLabel">@lang(' Details Parent') of {{ $eleve->name }} {{ $eleve->prename }}</h5>
                                                    <button style="background-color: #042954;color:white;" type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                @foreach ($eleve->users()->get() as $parent)
                                                <div>
                                                    @csrf
                                                    <div class="modal-body">
                                                        <div class="form-group row">
                                                    ...
                                                    <div class="modal-footer border-top-0 d-flex justify-content-center">
                                                        ...
                                                        <a href="{{ route('dashboard_manage.fathers.edit', $parent->id) }}"><button style="font-size: 2rem;background-color: #042954;border:none;" class="btn btn-secondary mr-4" id="formSubmit" class="btn btn-success">@lang('Edit ')</button></a>
                                                        <a href="{{ route('dashboard_manage.fathers.destroy', $parent->id) }}"><button style="font-size: 2rem;background-color: #d64214;border:none;" class="btn btn-secondary mr-4" id="formSubmit" class="btn btn-success">@lang('Delete ')</button></a>
                                                    </div>
                                                </div>
                                                @endforeach
                                            </div>
