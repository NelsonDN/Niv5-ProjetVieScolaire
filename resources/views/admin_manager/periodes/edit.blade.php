                    ...
                    <div class="col-4-xxxl col-12">
                        <div class="card height-auto">
                            <div class="card-body">
                                ...
                                <form class="new-added-form" method="POST" action="{{route('dashboard_manage.periode.update', $periode->id)}}" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <section id="elm" class="mb-4" >
                                        <div class="row">
                                            <div class="col-6-xxxl col-lg-3 col-8 form-group">
                                                ...
                                                <input value="{{$periode->jour}}" name="jour" type="text" placeholder="" class="form-control">
                                                @error('jour')
                                            ...
                                            <div class="col-6-xxxl col-lg-3 col-8 form-group">
                                                ...
                                                <input value="{{$periode->heure_debut}}" name="starttime" type="time" placeholder="" class="form-control">
                                                @error('starttime')
                                                <span class="form-text text-muted" role="alert"><strong class="text-danger">{{ $message }}</strong></span>
                                                @enderror
                                            </div>
                                            <div class="col-6-xxxl col-lg-3 col-8 form-group">
                                                ...
                                                <input value="{{$periode->heure_fin}}" name="endtime" type="time" placeholder="" class="form-control">
                                                @error('endtime')
                                                <span class="form-text text-muted" role="alert"><strong class="text-danger">{{ $message }}</strong></span>
                                                @enderror
                                            </div>
