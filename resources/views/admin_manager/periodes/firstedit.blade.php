                    ...
                    <div class="col-4-xxxl col-12">
                        <div class="card height-auto">
                            <div class="card-body">
                                ...
                                <form class="new-added-form" method="POST" action="{{route('dashboard_manage.periode.demi_update', $groupeperiode->id)}}" enctype="multipart/form-data">
                                    @csrf
                                    @method('POST')
                                        ...
                                        <div class="row">
                                            <div class="col-xl-5 col-lg-3 col-12 form-group">
                                                ...
                                                @foreach($jours as $jour)
                                                    <option @if($jour->groupeperiode_id == $groupeperiode->id) selected @endif value="{{$jour->id}}">
                                                        {{$jour->jour}}
                                                    </option>
                                                @endforeach
                                                </select>
                                            ...
                                            <div class="col-6-xxxl col-lg-3 col-8 form-group">
                                                ...
                                                <input value="{{$groupeperiode->heure_debut}}" name="starttime" type="time" placeholder="" class="form-control">
                                                @error('starttime')
                                                <span class="form-text text-muted" role="alert"><strong class="text-danger">{{ $message }}</strong></span>
                                                @enderror
                                            </div>
                                            <div class="col-6-xxxl col-lg-3 col-8 form-group">
                                                ...
                                                <input value="{{$groupeperiode->heure_fin}}" name="endtime" type="time" placeholder="" class="form-control">
                                                @error('endtime')
                                                <span class="form-text text-muted" role="alert"><strong class="text-danger">{{ $message }}</strong></span>
                                                @enderror
                                            </div>
                                            <div class="col-6-xxxl col-lg-5 col-8 form-group">
                                                ...
                                                <input value="{{$groupeperiode->duree_periode}}" name="duree_period" type="time" placeholder="" class="form-control">
                                                @error('duree_period')
                                                <span class="form-text text-muted" role="alert"><strong class="text-danger">{{ $message }}</strong></span>
                                                @enderror
                                            </div>
                                            <div class="col-6-xxxl col-lg-5 col-8 form-group">
                                                ...
                                                <input value="{{$groupeperiode->nbre_pause}}" name="nbre_pause" type="number" placeholder="" class="form-control">
                                                @error('nbre_pause')
                                                <span class="form-text text-muted" role="alert"><strong class="text-danger">{{ $message }}</strong></span>
                                                @enderror
                                            </div>
