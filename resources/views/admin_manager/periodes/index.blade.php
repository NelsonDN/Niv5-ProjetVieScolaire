                            ...
                            <div class="row gutters-8">
                                <div class="col-1-xxxl col-xl-2 col-lg-3 col-12 form-group">
                                    ...
                                    <button type="submit" class="fw-btn-fill btn-gradient-yellow">
                                        <a class="fw-bold text-white" href="{{route('dashboard_manage.period.create')}}">    
                                        @lang('Add Group Period')
                                        </a>
                                    </button>
                                </div>
                            ...
                            <table class="table display data-table text-nowrap">
                                <thead>
                                    <tr>
                                        ...
                                        <th>@lang('Day Start time')</th>
                                        <th>@lang('Day End time')</th>
                                        <th>@lang('Duration of a period')</th>
                                        <th>@lang('Number of breaks')</th>
                                        <th>Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach($groupeperiodes as $groupeperiode)
                                        <tr>
                                            <td>
                                                <div class="form-check">
                                            ...
                                            <td>{{$groupeperiode->heure_debut}}</td>
                                            <td>{{$groupeperiode->heure_fin}}</td>
                                            <td>{{$groupeperiode->duree_periode}}</td>
                                            <td>{{$groupeperiode->nbre_pause}}</td>
                                            <td>
                                                <a href="{{ route('dashboard_manage.period.edit', $groupeperiode->id)}}"
                                                ...
                                                <a href="{{route('dashboard_manage.period.show', $groupeperiode->id)}}"
                                                        class="btn btn-sm btn-clean btn-icon mr-2" title="See list">
                                                ...
                                                <button onclick="deleteItem(this)" data-id="{{ $groupeperiode->id }}"  class="btn btn-sm btn-clean btn-icon  delete"
                                                    title="Delete"> 
