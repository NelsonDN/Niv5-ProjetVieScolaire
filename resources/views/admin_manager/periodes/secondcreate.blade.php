        ...
        <div class="dashboard-page-one">
            ...
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    ...
                    <ul>
                        <li>
                            <a href="{{ route('dashboard_manage.period.create') }}">@lang('Home')</a>
                        </li>
                        <li>@lang('Periods')</li>
                    </ul>
                </div>
                    ...
                    <div class="col-4-xxxl col-12">
                        <div class="card height-auto">
                            <div class="card-body">
                                ...
                                <form class="new-added-form" method="POST" action="{{route('dashboard_manage.period.store')}}" enctype="multipart/form-data">
                                    @csrf
                                    @method('POST')
                                    @include('admin_manager.flash-message')
                                    <section id="elm" class="mb-4" >
                                        @if(session()->has('nbre_pause'))
                                            @php
