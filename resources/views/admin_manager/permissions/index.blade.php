                    ...
                    <div class="col-4-xxxl col-12">
                        <div class="card height-auto">
                            <div class="card-body">
                                ...
                                <form class="new-added-form" method="POST" action="{{route('permissions.store')}}" enctype="multipart/form-data">
                                    @csrf
                                            ...
                                            @foreach ($permissions as $permission)
                                                <tr data-entry-id="">
                                                    ...
                                                    <td>
                                                        ...
                                                        <button onclick="deleteItem(this)" data-id="{{ $permission->id }}" class="btn btn-sm btn-clean btn-icon  delete"
                                                            title="Delete"> 
