                    ...
                    <div class="col-4-xxxl col-12">
                        <div class="card height-auto">
                            <div class="card-body">
                                ...
                                <form class="new-added-form" method="POST" action="{{route('roles.update', $role->id)}}" enctype="multipart/form-data">
                                    @csrf
                                    @method('put')
                                    ...
                                    <div class="row">
                                        <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                            ...
                                            <input type="text" value="{{$role->name}}" name="name" placeholder="" class="form-control">
                                        </div>
                                        ...
                                        <div  class="col-12-xxxl col-lg-6 col-12 form-group">
                                            ...
                                            <select name="permissions[]" style="background-color: #f0f1f3;height: 50px; width:100%; border:none;border-radius: 4px;" multiple class="select2">
                                            <option >@lang('select')</option>
                                                @foreach($permissions as $permission)
                                                    <option value="{{$permission->id}}"  @isset($role) @if(in_array($permission->id,$role->permissions->pluck('id')->toArray())) selected @endif @endisset>{{$permission->name}}</option>
                                                @endforeach
                                            </select>
                                            @error('permissions.*')
                                            <span class="form-text text-muted" role="alert"><strong class="text-danger">{{ $message }}</strong></span>
