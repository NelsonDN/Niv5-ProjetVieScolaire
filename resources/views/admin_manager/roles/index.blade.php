                    ...
                    <div class="col-4-xxxl col-12">
                        <div class="card height-auto">
                            <div class="card-body">
                                ...
                                <form class="new-added-form" method="POST" action="{{route('roles.store')}}" enctype="multipart/form-data">
                                    @csrf
                                            ...
                                            <tr>
                                                <th>
                                                    <div class="form-check">
                                                        ...
                                                        <label class="form-check-label">@lang('N°')</label>
                                                    </div>
                                                </th>
                                                <th>@lang('Name')</th>
                                                <th>@lang('Actions')</th>
                                            ...
                                            @foreach ($roles as $role)
                                                <tr data-entry-id="">
                                                    ...
                                                    <td>
                                                        ...
                                                        <button onclick="deleteItem(this)" data-id="{{ $role->id }}" class="btn btn-sm btn-clean btn-icon  delete"
                                                            title="Delete"> 
