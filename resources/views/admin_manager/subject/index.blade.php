                    ...
                    <div class="col-4-xxxl col-12">
                        <div class="card height-auto">
                            <div class="card-body">
                                ...
                                <form class="new-added-form" method="POST" action="{{route('dashboard_manage.subject.store')}}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <table class="table display data-table text-nowrap">
                                        ...
                                        <tbody>
                                                ...
                                                <td>
                                                    ...
                                                    <td>
                                                        <a href="#" class="btn btn-danger" onclick="if (confirm('Voulez-vous vraiment supprimer la matière __ {{ $matiere->nom }}__ ?')){document.getElementById('form-{{$matiere->id}}').submit()}" >@lang('Delete')</a>
                                                            <form id="form-{{$matiere->id}}" method="post" action ="{{ route('dashboard_manage.subject.destroy', ['subject'=> $matiere->id])}}">
                                                            @csrf
                                                            @method('DELETE')
