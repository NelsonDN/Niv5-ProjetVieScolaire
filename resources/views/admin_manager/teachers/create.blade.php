            ...
            <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <form class="new-added-form" method="POST" action="{{ route('dashboard_manage.teachers.store')}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    @foreach($classe_matieres as $matiere)
                                        <option value="{{ $matiere->matiere_id . ',' . $matiere->classe_id }}">
                                            {{ App\Models\Matiere::findOrFail($matiere->matiere_id)->nom }}
                                           ({{ App\Models\Classe::findOrFail($matiere->classe_id)->nom }})
                                        </option>
                                    @endforeach
                                    </select>
                                    @error('matiere.*')
