        ...
        <div class="dashboard-page-one">
            ...
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    <h3>@lang('Type of Lessons')</h3>
                    <ul>
                        <li>
                            <a href="{{route('dashboard_manage.type_of_lesson.index')}}">@lang('Home')</a>
                        </li>
                        <li>@lang('Type of lesson')</li>
                    </ul>
                </div>
                            ...
                            <div class="card-body">
                                <div class="heading-layout1">
                                    <div class="item-title">
                                        <h3>@lang('Edit Type of Lesson')</h3>
                                    </div>
                                    <div class="dropdown">
                                ...
                                <form class="new-added-form" method="POST" action="{{route('dashboard_manage.type_of_lesson.update', $typedecour->id)}}" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <section id="elm" class="mb-4" >
                                        <div class="row">
                                            <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                                <label>@lang('Type of lesson Name')</label>
                                                <input value="{{$typedecour->nom}}" name="name" type="text" placeholder="" class="form-control">
                                                @error('name')
                    ...
                    <div class="col-8-xxxl col-12">
                        <div class="card height-auto">
                            <div class="card-body">
                                <div class="heading-layout1">
                                    <div class="item-title">
                                        <h3>@lang('All Types of lesson')</h3>
                                    </div>
                                    <div class="dropdown">
                                        <a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                                            aria-expanded="false">...</a>
                                    ...
                                    <table class="table display data-table text-nowrap">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>@lang('Type of Lesson Name')</th>
                                                <th>@lang('Supp')</th>
                                                <th>@lang('Actions')</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                                ...
                                                <td>
                                                    ...
                                                    <td>{{$type->nom}}</td>
                                                    <td>
                                                        <a href="#" class="btn btn-danger" onclick="if (confirm('Voulez-vous vraiment supprimer le type de cours __ {{ $type->nom }}__ ?')){document.getElementById('form-{{$type->id}}').submit()}" >@lang('Delete')</a>
                                                            <form id="form-{{$type->id}}" method="post" action ="{{ route('dashboard_manage.type_of_lesson.destroy',  $type->id)}}">
                                                            @csrf
                                                            @method('DELETE')
                                                    ...
                                                    <td>
                                                        <a href="{{ route('dashboard_manage.type_of_lesson.edit', $type->id)}}"
                                                        ...
                                                        <button onclick="deleteItem(this)" data-id="{{ $type->id }}" class="btn btn-sm btn-clean btn-icon  delete"
                                                            title="Delete"> 
