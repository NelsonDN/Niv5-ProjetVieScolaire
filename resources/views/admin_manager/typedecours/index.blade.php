        ...
        <div class="dashboard-page-one">
            ...
            <div class="dashboard-content-one">
                ...
                <div class="breadcrumbs-area">
                    ...
                    <ul>
                        <li>
                            <a href="Sections/create">@lang('Home')</a>
                        </li>
                            ...
                            <div class="card-body">
                                <div class="heading-layout1">
                                    <div class="item-title">
                                        <h3>@lang('Add New Type of Lesson')</h3>
                                    </div>
                                    <div class="dropdown">
                                ...
                                <form class="new-added-form" method="POST" action="{{route('dashboard_manage.type_of_lesson.store')}}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <section id="elm" class="mb-4" >
                                        <div class="row">
                                            <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                                ...
                                                <input value="{{old('name.*')}}" name="name[]" type="text" placeholder="" class="form-control">
                                                @error('name.*')
