            ...
            <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <form class="new-added-form" method="POST" action="{{ route('users.update', $user->id)}}" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" value="{{$user->name}}" name="name" placeholder="" class="form-control">
                                    @error('name')
                                    <span class="form-text text-muted" role="alert"><strong class="text-danger">{{ $message }}</strong></span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-xl-4 col-lg-6 col-12 form-group">
                                    ...
                                    <select name="active" class="select2"  required>
                                        ...
                                        <option value="1" @if($user->is_active === "1") selected @endif>@lang('Yes')</option>
                                        <option value="0" @if($user->is_active === "0") selected @endif>@lang('No')</option>
                                    </select>
                                    @error('active.*')
                                        <span class="form-text text-muted" role="alert"><strong class="text-danger">{{ $message }}</strong></span>
                                    @enderror
